...
public class Navigation {
    ...
    public final String Add_TRANSPORTATION_FXML = "views/addTransportation.fxml";
    ...
    public final String TEACH_FXML = "views/teach.fxml";
    public final String ADD_TEACH_FXML = "views/addTeacher.fxml";
    ...
    public final String TRANSPORTATION = "views/transportation.fxml";
